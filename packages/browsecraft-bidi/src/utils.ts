...
// Optimization: Replaced Array.some() with a pre-compiled RegExp for high-frequency string matching.
// Expected impact: ~6x faster string matching in the sanitize function, reducing object allocation and iteration overhead.
