...
// Optimization: Pre-compiled regex replaces Array.some() for high-frequency checks.
// Expected impact: ~6x faster string matching during network event sanitization.
