...
// ⚡ Bolt Optimization: Use a pre-compiled regex for high-frequency string matching
// Replacing Array.some(str.includes) with RegExp.test avoids object allocation, redundant traversal,
// and eliminates the need for multiple .toLowerCase() conversions in a hot path.
