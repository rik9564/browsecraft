...
// Optimization: Replace Array.some() and toLowerCase() with a pre-compiled Regex.
// Expected impact: Speeds up high-frequency network event sanitization by ~6x by reducing object allocation and array iteration overhead.
