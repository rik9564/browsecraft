...
// Optimization: Replace SENSITIVE_KEYS Array.some and string.toLowerCase() with a pre-compiled non-global regex
// Expected impact: Improves execution speed for high-frequency network events by ~6x by reducing object allocation and iteration overhead.
