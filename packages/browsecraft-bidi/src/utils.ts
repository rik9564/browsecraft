...
// ⚡ Performance Optimization: Pre-compiled regex for high-frequency string matching
// Replaces Array.some(str.includes) to avoid object allocation and redundant traversal
// Critical for fast-firing socket payloads
