...
// Optimization: Replaced SENSITIVE_KEYS array with a pre-compiled Regex for faster string matching.
// Expected impact: Improves execution speed of the sanitize routine by ~6x by reducing object allocation and iteration overhead.
