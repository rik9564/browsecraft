...
// Performance Optimization: RegExp.test with a pre-compiled regex is significantly faster
// than Array.some(str.includes) for high-frequency string matching because it avoids
// object allocation and redundant traversal.
