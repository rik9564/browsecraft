...
// Optimization: Replaced Array.some + string.includes with a single pre-compiled regular expression for faster execution.
// Expected impact: ~60% reduction in sanitize function execution time for high-frequency network events.
