...
export function sanitize(obj: unknown): unknown {
	...
	for (const [key, value] of Object.entries(record)) {
		...
		// Optimization: Use pre-compiled Regex instead of Array.some() for high-frequency checks
		// Expected impact: ~2x execution speed improvement by reducing iteration overhead
