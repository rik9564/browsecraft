...
// Performance: Pre-compiled RegExp is significantly faster than Array.some(str.includes)
// for high-frequency sanitization of fast-firing socket payloads.
const SENSITIVE_KEYS_REGEX = /(?:authorization|cookie|password|token|secret|session|auth)/i;
