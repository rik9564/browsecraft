...
// Pre-compiled regex is preferred over Array.some(str.includes) for high-frequency string matching
// as it avoids object allocation, redundant traversal, and is significantly faster in Node.js.
