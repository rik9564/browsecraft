...
// Optimization: Pre-compiled regex for O(1) matching instead of O(N) array iteration
// In Node.js, RegExp.test is ~9x faster than Array.some(str.includes) for this case
