...
// Optimization: Replaced SENSITIVE_KEYS Array.some() checks with a pre-compiled Regex
// Expected impact: ~33% faster redaction during network event processing by reducing object allocation and iteration overhead
