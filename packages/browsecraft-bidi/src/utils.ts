...
// Use a pre-compiled RegExp instead of Array.prototype.some() for O(1) matching vs O(n) array traversal.
// This function runs on high-frequency socket payloads, so avoiding string allocation and loop overhead is critical.
