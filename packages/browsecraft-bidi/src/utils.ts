...
// Pre-compiled Regex for faster matching (preferred over Array.some(str.includes))
...
export function sanitize(obj: unknown): unknown {
	...
	for (const [key, value] of Object.entries(record)) {
		...
		// Optimization: Use RegExp.test instead of Array.some(str.includes) to avoid object allocation
