...
// Optimization: Replace array iteration with a pre-compiled, non-global RegExp
// Expected impact: ~3x performance improvement in deep object sanitization due to reduced allocations and iterations
