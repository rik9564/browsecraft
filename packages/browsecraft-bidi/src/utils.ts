...
// ⚡ Bolt Optimization: Using a pre-compiled case-insensitive regex instead of
// Array.some(str.includes) significantly reduces CPU overhead and avoids
// object allocations during high-frequency BiDi payload sanitization.
